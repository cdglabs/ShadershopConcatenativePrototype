...
(function() {
  var Apply, Chain, ContentEditableMixin, DraggingView, Editor, Env, Fn, Graph, GraphView, Link, MainGraphView, Param, ParamTitleView, ParamValueView, ParamView, PointerManager, R, StartLink, animLoop, compose, config, cx, drawLine, editor, fnsToAdd, lerp, pointerManager, pointerdown, pointermove, pointerup, refreshView, ticks, truncate, updateHover, _base, _ref, _ref1,
