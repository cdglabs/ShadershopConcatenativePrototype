...
(function() {
  var AnnotateMixin, Apply, ApplyInternalsView, ApplyRowView, ApplyThumbnailView, ApplyView, ContentEditableMixin, DataForMixin, DraggingView, Editor, Fn, Graph, GraphView, GridView, MainGraphView, Param, ParamTitleView, ParamValueView, ParamView, PossibleApplyView, ProvisionalApply, ProvisionalApplyView, R, compose, config, cx, drawLine, editor, fnsToAdd, lastHoveredEls, lerp, onceDragConsummated, pointermove, pointerup, refresh, refreshView, ticks, truncate, updateHover, updateHover2, _base, _ref, _ref1,
  ...
  */
  ...
  GraphView = React.createClass({
    ...
    refreshGraph: function() {
      var apply, canvas, drawOptions, graph, graphFn, s, spreadOffset, styleOpts, _ref;
      _ref = this.props, apply = _ref.apply, spreadOffset = _ref.spreadOffset, styleOpts = _ref.styleOpts;
      if (spreadOffset == null) {
        spreadOffset = 0;
      }
      canvas = this.getDOMNode();
      ...
      if (_.isEqual(drawOptions, this.lastDropOptions_)) {
        return;
      }
      this.lastDropOptions_ = drawOptions;
      graph = canvas.graph != null ? canvas.graph : canvas.graph = new Graph(canvas, -10, 10, -10, 10);
      graph.clear();
