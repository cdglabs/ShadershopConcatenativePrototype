...
(function() {
  var AddLinkView, AnnotateMixin, Apply, Chain, ContentEditableMixin, DraggingView, Editor, Env, Fn, Graph, GraphView, Link, LinkRowView, LinkView, MainGraphView, Param, ParamTitleView, ParamValueView, ParamView, R, StartLink, compose, config, cx, drawLine, editor, fnsToAdd, lerp, pointermove, pointerup, refresh, refreshView, ticks, truncate, updateHover, _base, _ref, _ref1,
