...
(function() {
  var Apply, Chain, ContentEditableMixin, DraggingView, Editor, Env, Fn, Graph, GraphView, Link, MainGraphView, Param, ParamTitleView, ParamValueView, ParamView, PointerManager, R, StartLink, compose, config, cx, drawLine, editor, fnsToAdd, lerp, pointerManager, pointerdown, pointermove, pointerup, refresh, refreshView, ticks, truncate, updateHover, _base, _ref, _ref1,
