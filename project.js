...
(function() {
  var Apply, ApplyInternalsView, ApplyRowView, ApplyThumbnailView, ApplyView, CanvasView, ContentEditableMixin, DataForMixin, DraggingView, Editor, Fn, Graph, GraphView, GridView, MainCartesianGraphView, MainGraphView, MainShaderGraphView, ObjectManager, OutputSwitchView, Param, ParamSlotView, ParamTitleView, ParamValueView, ParamView, PossibleApplyView, ProvisionalApply, ProvisionalApplyView, R, Shader, ShaderGraphView, TranscludeMixin, compose, config, cx, drawLine, editor, fnsToAdd, handleWindowMouseMove, handleWindowMouseUp, lerp, loadInitialEditor, loadState, onceDragConsummated, refresh, refreshView, saveState, ticks, truncate, _base, _ref, _ref1,
