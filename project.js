...
(function() {
  var AnnotateMixin, Apply, ApplyInternalsView, ApplyRowView, ApplyThumbnailView, ApplyView, ContentEditableMixin, DataForMixin, DraggingView, Editor, Fn, Graph, GraphView, GridView, MainGraphView, Param, ParamTitleView, ParamValueView, ParamView, PossibleApplyView, ProvisionalApply, ProvisionalApplyView, R, Shader, ShaderGraphView, compose, config, cx, drawLine, editor, fnsToAdd, lastHoveredEls, lerp, onceDragConsummated, pointermove, pointerup, refresh, refreshView, ticks, truncate, updateHover, updateHover2, _base, _ref, _ref1,
