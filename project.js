...
(function() {
  var AddLinkView, AnnotateMixin, Apply, ApplyThumbnailView, ApplyView, ContentEditableMixin, DraggingView, Editor, Fn, Graph, GraphView, LinkRowView, LinkThumbnailView, LinkView, MainGraphView, Param, ParamTitleView, ParamValueView, ParamView, R, compose, config, cx, drawLine, editor, fnsToAdd, lerp, onceDragConsummated, pointermove, pointerup, refresh, refreshView, ticks, truncate, updateHover, _base, _ref, _ref1,
  ...
  */
  ...
  Fn = (function() {
    function Fn(title, numParams, compileString) {
      this.title = title;
  ...
  Editor = (function() {
    ...
    Editor.prototype.removeApply = function(apply) {
      ...
      if (this.root === apply) {
        ...
        if (nextApply) {
          return nextApply.params[0] = apply.params[0];
        }
      }
    };
    ...
    Editor.prototype.insertApplyAfter = function(apply, refApply) {
      ...
      if (this.root === refApply) {
        this.root = apply;
        return apply.params[0] = refApply;
      } else {
