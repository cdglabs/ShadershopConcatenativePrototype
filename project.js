...
(function() {
  var Apply, ApplyInternalsView, ApplyRowView, ApplyThumbnailView, ApplyView, CanvasView, ContentEditableMixin, DataForMixin, DraggingView, Editor, Fn, Graph, GraphView, GridView, MainCartesianGraphView, MainGraphView, MainShaderGraphView, ObjectManager, OutputSwitchView, Param, ParamSlotView, ParamTitleView, ParamValueView, ParamView, Persistence, PossibleApplyView, ProvisionalApply, ProvisionalApplyView, R, Shader, ShaderGraphView, TranscludeMixin, compose, config, cx, drawLine, editor, fnsToAdd, handleWindowMouseMove, handleWindowMouseUp, lerp, onceDragConsummated, refresh, refreshView, ticks, truncate, _base, _ref, _ref1,
  ...
  */
  ...
  Persistence = new ((function() {
    ...
    _Class.prototype.saveState = function() {
    ...
    _Class.prototype.loadInitialEditor = function() {
      var a, editor;
      editor = new Editor();
      a = new Param();
      editor.xParam = a;
